...
namespace TSH.Core
{
    ...
    ================================================================================
    Definitions for the Structural Dynamic OS.
    ================================================================================
    */
    ...
    public struct MaterialCoeffs
    {
        ...
        public float alpha; // contracting tension
    ...
    [CreateAssetMenu(fileName = "TSHMaterial", menuName = "TSH/Consistent Material v1.0")]
